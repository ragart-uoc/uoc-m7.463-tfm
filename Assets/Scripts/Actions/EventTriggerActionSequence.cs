...
{
    /// <summary>
    /// Class <c>EventTriggerActionSequence</c> represents a sequence of actions that will be executed when a trigger event is fired.
    /// </summary>
    [System.Serializable]
    public struct EventTriggerActionSequence
    {
